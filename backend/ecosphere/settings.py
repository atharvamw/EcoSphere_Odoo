...
from celery.schedules import crontab# Build paths inside the project like this: BASE_DIR / 'subdir'.
...
SECRET_KEY = 'django-insecure-rin0g0yqs_wy24^ea^#xbwsoy88-rrpnoapmy(2ksr-1n)74y0'
